  ...
  <Popover triggeredBy="#p{pid}"  placement='right'>
    ...
    <table>
      <tbody>
        ...
        <td>
          <h2>
            <a href="https://www.aoe2companion.com/profile/{ofs(pid).profile_id}"   target="_blank"  class="text-primary-600 dark:text-primary-500 hover:underline"> {ofs(pid).name}</a>    
          </h2>
        </td>
      </tr>
